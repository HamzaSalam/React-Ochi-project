function Footer() {
  return (
    <div className="w-full h-screen flex justify-between bg-zinc-900 p-20 font-['Founders Grotesk X-Condensed']">
      <div className="w-1/2 h-full flex flex-col justify-between ">
        <div className="heading">
          <h1 className="text-[6vw] font-semibold uppercase leading-none -mb-2">
            Eye-
          </h1>
          <h1 className="text-[6vw] font-semibold uppercase leading-none -mb-8">
            Opening
          </h1>
        </div>
        <svg
